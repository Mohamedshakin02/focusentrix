...
export default function Checkout() {
    ...
    return (
        <div className="bg-[#0a0a0f] min-h-screen text-white">
            ...
            */}
            <section className="w-full px-4 sm:px-6 lg:px-20 pt-16 pb-8">
            ...
            */}
            ...
            <section className="w-full px-4 sm:px-6 lg:px-20 pb-20">
                <div className="max-w-6xl mx-auto bg-[#0e0b1e] border border-[#1e1535] rounded-2xl px-6 sm:px-10 py-8">
